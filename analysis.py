...
data = pd.read_csv('rezultati_analiticki.csv')

# Definišite boje i simbole za svaku krivu
colors = ['b', 'g', 'r']
symbols = ['o', '^', 's']
...
for r in r_values:
    ...
    plt.legend(loc='upper right')
    plt.grid(True)
    plt.savefig(f'docs/Tsys_{r}.png')
    plt.show()